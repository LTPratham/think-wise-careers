  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold font-outfit text-slate-900">Study Abroad Destinations</h2>
          <p className="text-slate-500 mt-1">Manage country pages and linked universities.</p>
        </div>
        <Button asChild>
        ...
        <table className="w-full text-sm text-left">
          <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
            <tr>
              ...
              <th className="px-6 py-4">Universities</th>
